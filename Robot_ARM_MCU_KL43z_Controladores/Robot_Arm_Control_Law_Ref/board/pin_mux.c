...
- {pin_num: '35', pin_signal: LCD_P0/ADC0_SE8/PTB0/LLWU_P5/I2C0_SCL/TPM1_CH0, label: 'J4[2]/A0/LCD_P0', identifier: Sensor_1}
- {pin_num: '36', pin_signal: LCD_P1/ADC0_SE9/PTB1/I2C0_SDA/TPM1_CH1, label: 'J4[4]/A1/LCD_P1', identifier: Sensor_2}
...
- pin_list:
  - {pin_num: '20', peripheral: I2C0, signal: SCL, pin_signal: PTE24/TPM0_CH0/I2C0_SCL, identifier: Sensor_1_e_2_SCL}
  - {pin_num: '21', peripheral: I2C0, signal: SDA, pin_signal: PTE25/TPM0_CH1/I2C0_SDA, identifier: Sensor_1_e_2_SDA}
  ...
  - {pin_num: '25', peripheral: TPM0, signal: 'CH, 0', pin_signal: PTA3/I2C1_SCL/TPM0_CH0/SWD_DIO, direction: OUTPUT}
  - {pin_num: '26', peripheral: TPM0, signal: 'CH, 1', pin_signal: PTA4/I2C1_SDA/TPM0_CH1/NMI_b, identifier: PWM2, direction: OUTPUT}
  - {pin_num: '27', peripheral: TPM0, signal: 'CH, 2', pin_signal: PTA5/USB_CLKIN/TPM0_CH2/I2S0_TX_BCLK, identifier: PWM3, direction: OUTPUT}
  ...
  - {pin_num: '35', peripheral: GPIOB, signal: 'GPIO, 0', pin_signal: LCD_P0/ADC0_SE8/PTB0/LLWU_P5/I2C0_SCL/TPM1_CH0, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: '36', peripheral: GPIOB, signal: 'GPIO, 1', pin_signal: LCD_P1/ADC0_SE9/PTB1/I2C0_SDA/TPM1_CH1, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: '37', peripheral: GPIOB, signal: 'GPIO, 2', pin_signal: LCD_P2/ADC0_SE12/PTB2/I2C0_SCL/TPM2_CH0, direction: OUTPUT, gpio_init_state: 'true'}
  - {pin_num: '38', peripheral: GPIOB, signal: 'GPIO, 3', pin_signal: LCD_P3/ADC0_SE13/PTB3/I2C0_SDA/TPM2_CH1, direction: OUTPUT, gpio_init_state: 'true'}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PORTA3 (pin 25) is configured as TPM0_CH0 */
    PORT_SetPinMux(BOARD_PWM1_PORT, BOARD_PWM1_PIN, kPORT_MuxAlt3);

    /* PORTA4 (pin 26) is configured as TPM0_CH1 */
    PORT_SetPinMux(BOARD_PWM2_PORT, BOARD_PWM2_PIN, kPORT_MuxAlt3);

    /* PORTA5 (pin 27) is configured as TPM0_CH2 */
    PORT_SetPinMux(BOARD_PWM3_PORT, BOARD_PWM3_PIN, kPORT_MuxAlt3);
    ...
    PORT_SetPinMux(BOARD_Sensor_1_e_2_SCL_PORT, BOARD_Sensor_1_e_2_SCL_PIN, kPORT_MuxAlt5);

    /* PORTE25 (pin 21) is configured as I2C0_SDA */
    PORT_SetPinMux(BOARD_Sensor_1_e_2_SDA_PORT, BOARD_Sensor_1_e_2_SDA_PIN, kPORT_MuxAlt5);
