...
/*! @name PORTE1 (number 2), J2[12]/D15/I2C1_SCL/LCD_P49
  @{ */
#define BOARD_Sensor_3_e_4_SCL_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_3_e_4_SCL_PIN 1U     /*!<@brief PORTE pin index: 1 */
                                          /* @} */

/*! @name PORTE0 (number 1), J2[18]/J4[9]/D14/I2C1_SDA/CMP0_OUT/LCD_P48
  @{ */
#define BOARD_Sensor_3_e_4_SDA_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_3_e_4_SDA_PIN 0U     /*!<@brief PORTE pin index: 0 */
                                          /* @} */

/*! @name PORTD3 (number 60), J1[6]/D2/LCD_P43
  @{ */
#define BOARD_PWM4_PORT PORTD /*!<@brief PORT device name: PORTD */
#define BOARD_PWM4_PIN 3U     /*!<@brief PORTD pin index: 3 */
                              /* @} */

/*! @name PORTD4 (number 61), J2[6]/D10/SPI1_PCS0/LCD_P44
  @{ */
#define BOARD_PWM5_PORT PORTD /*!<@brief PORT device name: PORTD */
#define BOARD_PWM5_PIN 4U     /*!<@brief PORTD pin index: 4 */
                              /* @} */

/*! @name PORTD5 (number 62), J2[12]/D13/SPI1_SCK/LED1/LCD_P45
  @{ */
#define BOARD_PWM6_PORT PORTD /*!<@brief PORT device name: PORTD */
#define BOARD_PWM6_PIN 5U     /*!<@brief PORTD pin index: 5 */
                              /* @} */

/*! @name PORTE30 (number 18), J1[16]/J4[11]/D7/CMP0_IN4/DAC_OUT
  @{ */
#define BOARD_Saida_DAC_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Saida_DAC_PIN 30U    /*!<@brief PORTE pin index: 30 */
                                   /* @} */

/*! @name PORTC1 (number 44), J4[12]/A5/LCD_P21/I2S_TXD0
  @{ */
#define BOARD_PWM1_PORT PORTC /*!<@brief PORT device name: PORTC */
#define BOARD_PWM1_PIN 1U     /*!<@brief PORTC pin index: 1 */
                              /* @} */

/*! @name PORTC2 (number 45), J4[10]/A4/LCD_P22/I2S_TXD0
  @{ */
#define BOARD_PWM2_PORT PORTC /*!<@brief PORT device name: PORTC */
#define BOARD_PWM2_PIN 2U     /*!<@brief PORTC pin index: 2 */
                              /* @} */

/*! @name PORTD2 (number 59), J2[4]/D9/LCD_P42
  @{ */
#define BOARD_PWM3_PORT PORTD /*!<@brief PORT device name: PORTD */
#define BOARD_PWM3_PIN 2U     /*!<@brief PORTD pin index: 2 */
                              /* @} */

/*! @name PORTB1 (number 36), J4[4]/A1/LCD_P1
  @{ */
#define BOARD_Sensor_1_e_2_SDA_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_Sensor_1_e_2_SDA_PIN 1U     /*!<@brief PORTB pin index: 1 */
                                          /* @} */

/*! @name PORTB0 (number 35), J4[2]/A0/LCD_P0
  @{ */
#define BOARD_Sensor_1_e_2_SCL_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_Sensor_1_e_2_SCL_PIN 0U     /*!<@brief PORTB pin index: 0 */
                                          /* @} */

/*! @name PORTE20 (number 9), J4[1]/DIFF_ADC0_DP/LCD_P59
  @{ */
#define BOARD_Sensor_1_FGPIO FGPIOE /*!<@brief FGPIO device name: FGPIOE */
#define BOARD_Sensor_1_GPIO GPIOE /*!<@brief GPIO device name: GPIOE */
#define BOARD_Sensor_1_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_1_PIN 20U    /*!<@brief PORTE pin index: 20 */
                                  /* @} */

/*! @name PORTE21 (number 10), J4[3]/DIFF_ADC0_DM/LCD_P60
  @{ */
#define BOARD_Sensor_2_FGPIO FGPIOE /*!<@brief FGPIO device name: FGPIOE */
#define BOARD_Sensor_2_GPIO GPIOE /*!<@brief GPIO device name: GPIOE */
#define BOARD_Sensor_2_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_2_PIN 21U    /*!<@brief PORTE pin index: 21 */
                                  /* @} */

/*! @name PORTE22 (number 11), J4[5]/DIFF_ADC1_DP
  @{ */
#define BOARD_Sensor_3_FGPIO FGPIOE /*!<@brief FGPIO device name: FGPIOE */
#define BOARD_Sensor_3_GPIO GPIOE /*!<@brief GPIO device name: GPIOE */
#define BOARD_Sensor_3_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_3_PIN 22U    /*!<@brief PORTE pin index: 22 */
                                  /* @} */

/*! @name PORTE23 (number 12), J4[7]/DIFF_ADC1_DM
  @{ */
#define BOARD_Sensor_4_FGPIO FGPIOE /*!<@brief FGPIO device name: FGPIOE */
#define BOARD_Sensor_4_GPIO GPIOE /*!<@brief GPIO device name: GPIOE */
#define BOARD_Sensor_4_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_4_PIN 23U    /*!<@brief PORTE pin index: 23 */
                                  /* @} */

/*! @name PORTA5 (number 27), J1[12]/D5/I2S_TX_BCLK
  @{ */
#define BOARD_INTERRUPTION_FGPIO FGPIOA /*!<@brief FGPIO device name: FGPIOA */
#define BOARD_INTERRUPTION_GPIO GPIOA /*!<@brief GPIO device name: GPIOA */
#define BOARD_INTERRUPTION_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_INTERRUPTION_PIN 5U     /*!<@brief PORTA pin index: 5 */
                                      /* @} */
