...
- pin_list:
  ...
  - {pin_num: '44', peripheral: TPM0, signal: 'CH, 0', pin_signal: LCD_P21/ADC0_SE15/PTC1/LLWU_P6/RTC_CLKIN/I2C1_SCL/TPM0_CH0/I2S0_TXD0}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_I2S0_TXD0_PORT, BOARD_I2S0_TXD0_PIN, kPORT_MuxAlt4);
