...
/*! @name PORTE24 (number 20), U2[7]/U10[4]/I2C0_SCL
  @{ */
#define BOARD_Sensor_1_e_2_SCL_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_1_e_2_SCL_PIN 24U    /*!<@brief PORTE pin index: 24 */
                                          /* @} */

/*! @name PORTE25 (number 21), U2[6]/U10[6]/I2C0_SDA
  @{ */
#define BOARD_Sensor_1_e_2_SDA_PORT PORTE /*!<@brief PORT device name: PORTE */
#define BOARD_Sensor_1_e_2_SDA_PIN 25U    /*!<@brief PORTE pin index: 25 */
                                          /* @} */
...
/*! @name PORTA3 (number 25), J11[2]/SWD_DIO_TGTMCU
  @{ */
#define BOARD_PWM1_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_PWM1_PIN 3U     /*!<@brief PORTA pin index: 3 */
                              /* @} */

/*! @name PORTA4 (number 26), J1[10]/D4/SW1
  @{ */
#define BOARD_PWM2_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_PWM2_PIN 4U     /*!<@brief PORTA pin index: 4 */
                              /* @} */

/*! @name PORTA5 (number 27), J1[12]/D5/I2S_TX_BCLK
  @{ */
#define BOARD_PWM3_PORT PORTA /*!<@brief PORT device name: PORTA */
#define BOARD_PWM3_PIN 5U     /*!<@brief PORTA pin index: 5 */
                              /* @} */
...
/*! @name PORTB0 (number 35), J4[2]/A0/LCD_P0
  @{ */
#define BOARD_Sensor_1_FGPIO FGPIOB /*!<@brief FGPIO device name: FGPIOB */
#define BOARD_Sensor_1_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_Sensor_1_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_Sensor_1_PIN 0U     /*!<@brief PORTB pin index: 0 */
                                  /* @} */

/*! @name PORTB1 (number 36), J4[4]/A1/LCD_P1
  @{ */
#define BOARD_Sensor_2_FGPIO FGPIOB /*!<@brief FGPIO device name: FGPIOB */
#define BOARD_Sensor_2_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_Sensor_2_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_Sensor_2_PIN 1U     /*!<@brief PORTB pin index: 1 */
                                  /* @} */

/*! @name PORTB2 (number 37), J4[6]/A2/LCD_P2
  @{ */
#define BOARD_Sensor_3_FGPIO FGPIOB /*!<@brief FGPIO device name: FGPIOB */
#define BOARD_Sensor_3_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_Sensor_3_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_Sensor_3_PIN 2U     /*!<@brief PORTB pin index: 2 */
                                  /* @} */

/*! @name PORTB3 (number 38), J4[8]/A3/LCD_P3
  @{ */
#define BOARD_Sensor_4_FGPIO FGPIOB /*!<@brief FGPIO device name: FGPIOB */
#define BOARD_Sensor_4_GPIO GPIOB /*!<@brief GPIO device name: GPIOB */
#define BOARD_Sensor_4_PORT PORTB /*!<@brief PORT device name: PORTB */
#define BOARD_Sensor_4_PIN 3U     /*!<@brief PORTB pin index: 3 */
                                  /* @} */
